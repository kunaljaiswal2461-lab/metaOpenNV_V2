...
| Phase 3 LLM-on-env metrics | [`results/phase3_eval_metrics.md`](../results/phase3_eval_metrics.md), [`results/phase3_eval_bar.png`](../results/phase3_eval_bar.png) | base mean reward −0.044 / final PV $10,000; **sft mean reward +1.844 / final PV $10,718.64**; mirrored at `https://huggingface.co/Kj2461/metaOpenNV-sft-qwen15/tree/main/results`. Regenerate: `python scripts/eval_llm_on_env.py --models base=Qwen/Qwen2.5-1.5B-Instruct sft=Kj2461/metaOpenNV-sft-qwen15 --local` |
